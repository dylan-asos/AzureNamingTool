...
public class ResourceComponentsController : ControllerBase
{
    ...
    {
        var serviceResponse
            = _resourceComponentService.GetItems(admin);
    ...
    {
        var serviceResponse = _resourceComponentService.GetItem(id);
        return serviceResponse.Success
            ? (IActionResult) Ok(serviceResponse.ResponseObject)
            : (IActionResult) BadRequest(serviceResponse.ResponseObject);
    }
    ...
    [HttpPost]
    public IActionResult Post([FromBody] ResourceComponent item)
    {
        var serviceResponse = _resourceComponentService.PostItem(item);
    ...
    [HttpPost]
    [Route("[action]")]
    public IActionResult PostConfig([FromBody] List<ResourceComponent> items)
    {
