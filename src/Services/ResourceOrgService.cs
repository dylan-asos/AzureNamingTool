...
public class ResourceOrgService
{
    ...
    public ResourceOrgService(FileReader fileReader, FileWriter fileWriter)
    {
    ...
    public ServiceResponse GetItems()
    {
        ...
        // Get list of items
        var items = _fileReader.GetList<ResourceOrg>();
        if (items != null)
        {
    ...
    public ServiceResponse PostItem(ResourceOrg item)
    {
        ServiceResponse serviceResponse = new();
