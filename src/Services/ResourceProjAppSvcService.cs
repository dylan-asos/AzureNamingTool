...
public class ResourceProjAppSvcService
{
    ...
    public ResourceProjAppSvcService(FileReader fileReader, FileWriter fileWriter)
    {
    ...
    public ServiceResponse GetItems()
    {
        ...
        // Get list of items
        var items = _fileReader.GetList<ResourceProjAppSvc>();
        if (items != null)
        {
    ...
    public ServiceResponse PostItem(ResourceProjAppSvc item)
    {
        ServiceResponse serviceResponse = new();
